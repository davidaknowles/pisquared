...
namespace model_truncated_beta_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_truncated_beta");
    reader.add_event(29, 27, "end", "model_truncated_beta");
    return reader;
}

#include <stan_meta_header.hpp>
 class model_truncated_beta : public prob_grad {
private:
        int N;
        double sum_logp;
        double sum_log1mp;
        ...
        int beta_fixed;
public:
    model_truncated_beta(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_truncated_beta_namespace::model_truncated_beta";
        ...
        try {
            ...
            context__.validate_dims("data initialization", "sum_logp", "double", context__.to_vec());
            sum_logp = double(0);
            vals_r__ = context__.vals_r("sum_logp");
            pos__ = 0;
            sum_logp = vals_r__[pos__++];

            current_statement_begin__ = 5;
            context__.validate_dims("data initialization", "sum_log1mp", "double", context__.to_vec());
            sum_log1mp = double(0);
            vals_r__ = context__.vals_r("sum_log1mp");
            pos__ = 0;
            sum_log1mp = vals_r__[pos__++];

            current_statement_begin__ = 6;
            context__.validate_dims("data initialization", "upper_limit", "double", context__.to_vec());
            upper_limit = double(0);
            vals_r__ = context__.vals_r("upper_limit");
            pos__ = 0;
            upper_limit = vals_r__[pos__++];
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            lp_accum__.add((((alpha - 1.) * sum_logp) + ((beta - 1.) * sum_log1mp)));
            current_statement_begin__ = 26;
            lp_accum__.add((-(N) * (beta_cdf_log(upper_limit, alpha, beta) + lbeta(alpha, beta))));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_truncated_beta_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_truncated_beta_namespace::model_truncated_beta stan_model;
