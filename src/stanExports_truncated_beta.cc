...
#include "stanExports_truncated_beta.h"

RCPP_MODULE(stan_fit4truncated_beta_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_truncated_beta")
